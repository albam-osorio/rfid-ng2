...
// const API_HOST: string = "http://connect2.tacticlogistics.com:8585/sateliteDev";
...
//     getVistasDespachos() {
//         return this.http.get('resources/data/tms-s/vistas/despachos.json')
//             .toPromise()
//             .then(res => <Vista[]>res.json().data)
//             .then(data => { return data; });
//     }

//     getVistasRecogidas() {
//         return this.http.get('resources/data/tms-s/vistas/recogidas.json')
//             .toPromise()
//             .then(res => <Vista[]>res.json().data)
//             .then(data => { return data; });
//     }
